...
class RevolutImporter(identifier.IdentifyMixin, importer.ImporterProtocol):
    ...
    def extract(self, file, existing_entries):
        ...
        with StringIO(file.contents()) as csvfile:
            reader = csv.DictReader(csvfile, ['Date', 'Year', 'Reference', 'PaidOut', 'PaidIn', 'ExchangeOut', 'ExchangeIn', 'Balance', 'Category', 'Notes'], delimiter=',', skipinitialspace=True)
            next(reader)
            for row in reader:
                metakv = {
